...
def draw_predictions(img, detections, tracker, distance,filename=None ):
    ...
    track_centers = []
    all_data = []
    save_folder = '/home/n3xtr/Projects/SFA3D/results/output/'

    if not os.path.exists(save_folder):
        os.makedirs(save_folder)
    print(os.path.join(save_folder, filename+'.txt'))
    import pandas as pd
